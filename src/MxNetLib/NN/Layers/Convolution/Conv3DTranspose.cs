...
namespace MxNetLib.NN.Layers
{
    public class Conv3DTranspose : BaseLayer
    {
        ...
        public override Symbol Build(Symbol x)
        {
            ...
            return sym.Deconvolution(x, Symbol.Variable(weightName), Symbol.Variable(biasName), new Shape(KernalSize.Item1, KernalSize.Item2, KernalSize.Item3),
                                    ...
                                    new Shape(), new Shape(), 1, 512, !UseBias, null, false, null, ID);
        }
    }
}
