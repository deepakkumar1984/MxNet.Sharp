...
namespace MxNet.GluonCV.Losses
{
    public class SoftmaxCrossEntropyOHEMLoss : Loss
    {
        ...
        public SoftmaxCrossEntropyOHEMLoss(bool sparse_label= true, int batch_axis = 0, int ignore_label = -1, bool size_average = true, float? weight = null, string prefix = "", ParameterDict @params = null) : base(weight, batch_axis, prefix, @params)
        {
