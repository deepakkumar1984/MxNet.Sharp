...
namespace MxNet.GluonCV.ModelZoo.ActionRecognition
{
    ...
    {
        public I3D_InceptionV1(int nclass = 1000, bool pretrained_base = true, int num_segments = 1, int num_crop = 1, bool feat_ext = false, float dropout_ratio = 0.5f, float init_std = 0.01f, bool partial_bn = false, string prefix = "", ParameterDict @params = null) : base(prefix, @params)
        {
        }
        ...
        public static I3D_InceptionV1 I3D_InceptionV1_Kinetics400(int nclass = 400, bool pretrained = false, bool pretrained_base = true, bool use_tsn = false, int num_segments = 1, int num_crop = 1, bool partial_bn = true, Context ctx = null, string root = "")
        {
            throw new NotImplementedException();
        }
    }
