...
namespace MxNet.GluonCV.ModelZoo
{
    ...
    {
        public SENet(int[] layers, int cardinality, int bottleneck_width, bool avg_down= false, int classes= 1000, string norm_layer= "BatchNorm", FuncArgs norm_kwargs= null, string prefix = "", ParameterDict @params = null) : base(prefix, @params)
        {
        ...
        public static SENet GetSENet(int num_layers, int cardinality= 64, int bottleneck_width= 4, bool avg_down= false, bool pretrained= false, Context ctx= null,string root = "~/mxnet")
        {
            throw new NotImplementedException();
        }

        public static SENet SENet_154(int cardinality = 64, int bottleneck_width = 4, bool pretrained = false, Context ctx = null, string root = "~/mxnet")
        {
            return GetSENet(152, cardinality, bottleneck_width, false, pretrained, ctx, root);
        }

        public static SENet SENet_154e(int cardinality = 64, int bottleneck_width = 4, bool pretrained = false, Context ctx = null, string root = "~/mxnet")
        {
