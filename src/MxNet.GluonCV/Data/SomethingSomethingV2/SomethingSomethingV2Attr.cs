...
{
    public class SomethingSomethingV2Attr
    {
        public int NumClass = 174;

        public string[] Classes = new string[] {"Approaching something with your camera", "Attaching something to something",
