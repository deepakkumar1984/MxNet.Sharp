...
namespace MxNet
{
    public class SymImgApi
    {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol RandomColorJitter(Symbol data, float brightness, float contrast, float saturation, float hue,
            string symbol_name = "")
        {
        ...
        /// </param>
        /// <returns>returns new symbol</returns>
        public Symbol Resize(Symbol data, Shape size = null, bool keep_ratio = false, int interp = 1,
            string symbol_name = "")
        {
