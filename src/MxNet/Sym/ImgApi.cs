...
namespace MxNet
{
    public partial class SymImgApi
    {
        ...
        public Symbol Crop(Symbol data, int x, int y, int width, int height, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol ToTensor(Symbol data, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol Normalize(Symbol data, Tuple<double> mean = null, Tuple<double> std = null, string symbol_name = "")
        {
        ...
        /// <param name="data">The input.</param>
        /// <returns>returns new symbol</returns>
        public Symbol FlipLeftRight(Symbol data, string symbol_name = "")
        {
        ...
        /// <param name="data">The input.</param>
        /// <returns>returns new symbol</returns>
        public Symbol RandomFlipLeftRight(Symbol data, string symbol_name = "")
        {
        ...
        /// <param name="data">The input.</param>
        /// <returns>returns new symbol</returns>
        public Symbol FlipTopBottom(Symbol data, string symbol_name = "")
        {
        ...
        /// <param name="data">The input.</param>
        /// <returns>returns new symbol</returns>
        public Symbol RandomFlipTopBottom(Symbol data, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol RandomBrightness(Symbol data, float min_factor, float max_factor, string symbol_name = "")
        {
        ...
        /// <param name="max_factor">Maximum factor.</param>
        /// <returns>returns new symbol</returns>
        public Symbol RandomContrast(Symbol data, float min_factor, float max_factor, string symbol_name = "")
        {
        ...
        /// <param name="max_factor">Maximum factor.</param>
        /// <returns>returns new symbol</returns>
        public Symbol RandomSaturation(Symbol data, float min_factor, float max_factor, string symbol_name = "")
        {
        ...
        /// <param name="max_factor">Maximum factor.</param>
        /// <returns>returns new symbol</returns>
        public Symbol RandomHue(Symbol data, float min_factor, float max_factor, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol RandomColorJitter(Symbol data, float brightness, float contrast, float saturation, float hue, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol AdjustLighting(Symbol data, Tuple<double> alpha, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol RandomLighting(Symbol data, float alpha_std = 0.05f, string symbol_name = "")
        {
        ...
        /// <returns>returns new symbol</returns>
        public Symbol Resize(Symbol data, Shape size = null, bool keep_ratio = false, int interp = 1, string symbol_name = "")
        {
