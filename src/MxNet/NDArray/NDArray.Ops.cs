...
namespace MxNet
{
    public partial class NDArray
    {
        ...
        /// <returns>returns new NDArray</returns>
        public NDArray ShapeArray(int? lhs_begin = null, int? lhs_end = null, int? rhs_begin = null, int? rhs_end = null)
        {
        ...
        /// <returns>returns new NDArray</returns>
        public NDArray Topk(int? axis = -1, int k = 1, TopkRetTyp ret_typ = TopkRetTyp.Indices, bool is_ascend = false, DType dtype = null)
        {
