...
namespace MxNet.Image
{
    ...
    {
        public static DetRandomSelectAug CreateMultiRandCropAugmenter(float min_object_covered= 0.1f, (float, float)? aspect_ratio_range= null,
        ...
        public static DetAugmenter CreateDetAugmenter(Shape data_shape, int resize= 0, float rand_crop= 0, float rand_pad= 0, float rand_gray= 0,
                                                        ...
                                                        SharpCV.InterpolationFlags inter_method=  SharpCV.InterpolationFlags.INTER_CUBIC,
