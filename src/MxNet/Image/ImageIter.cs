...
namespace MxNet.Image
{
    public class ImageIter : DataIter
    {
        ...
        private int Batchify(DataBatch batch_data, DataBatch batch_label, int start= 0)=> throw new NotImplementedException();

        public void CheckDataShape(Shape data_shape) => throw new NotImplementedException();

        public void CheckValidImage(NDArray data) => throw new NotImplementedException();

        public NDArray ReadImage(string fname) => throw new NotImplementedException();

        public NDArray AugmentationTransform(NDArray data) => throw new NotImplementedException();

        public NDArray PostProcessData(NDArray datum) => throw new NotImplementedException();
    }
}
