...
namespace MxNet.Gluon.Contrib.NN
{
    public class SyncBatchNorm : BatchNorm
    {
        public SyncBatchNorm(int in_channels= 0, int? num_devices= null, float momentum= 0.9f, float epsilon= 1e-5f,
                            ...
                            string gamma_initializer= "ones", string running_mean_initializer= "zeros", string running_variance_initializer= "ones",
        ...
        internal int GetNumDevices() => throw new NotImplementedException();
