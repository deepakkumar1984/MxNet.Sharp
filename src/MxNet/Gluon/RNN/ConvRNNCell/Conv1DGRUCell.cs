...
{
    public class Conv1DGRUCell : _ConvRNNCell
    {
        public Conv1DGRUCell(Shape input_shape, int hidden_channels, int i2h_kernel, int h2h_kernel, int i2h_pad = 0, 
            int i2h_dilate = 1, int h2h_dilate = 1, string i2h_weight_initializer = null, string h2h_weight_initializer = null,
            string i2h_bias_initializer = "zeros", string h2h_bias_initializer = "zeros", string conv_layout = "NCW", string activation = "tanh") 
