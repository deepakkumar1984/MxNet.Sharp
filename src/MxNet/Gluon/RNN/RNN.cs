...
namespace MxNet.Gluon.RecurrentNN
{
    public class RNN : RNNLayer
    {
        public RNN(int hidden_size, int num_layers = 1, float dropout = 0, string layout = "TNC", bool bidirectional = false,
            ...
            DType dtype = null, string prefix = "", ParameterDict @params = null) : base(hidden_size, num_layers, layout, dropout, bidirectional, input_size, i2h_weight_initializer, h2h_weight_initializer, i2h_bias_initializer, h2h_bias_initializer, null, null, null, null, null, null, dtype, false, prefix, @params)
        {
