...
namespace MxNet.Gluon.NN
{
    ...
    {
        public AvgPool3D((int, int, int)? pool_size = null, (int, int, int)? strides = null, (int, int, int)? padding = null, string layout = "NCDHW",
                        ...
                        , ceil_mode, false, PoolingPoolType.Avg, layout, null, prefix, @params)
        {
