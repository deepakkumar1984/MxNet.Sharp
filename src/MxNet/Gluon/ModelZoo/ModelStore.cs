...
namespace MxNet.Gluon.ModelZoo
{
    ...
    {
        private static Dictionary<string, string> model_sha1 = new Dictionary<string, string>()
        {
        ...
        private static string apache_repo_url = "https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/";
        private static string _url_format = "{0}gluon/models/{1}.zip";
        ...
        public static string GetModelFile(string name, string root = "./models")
        {
            ...
            string zip_file_path = Path.Combine(root, file_name + ".zip");
