...
namespace MxNet.Gluon.Data.Vision
{
    public class DataLoader : IEnumerable, IDisposable
    {
        ...
        public static NDArrayList AsInContext(NDArrayList data, Context ctx) => throw new NotImplementedException();

        public static void WorkerLoopV1(Dataset<NDArray> dataset, Queue key_queue, Queue data_queue, Func<NDArrayList, bool> batchify_fn) => throw new NotImplementedException();
        ...
        public static void WorkerFn(int[] samples, Func<NDArrayList, NDArray> batchify_fn, Dataset<NDArray> dataset) => throw new NotImplementedException();

        public static void ThreadWorkerFn(int[] samples, Func<NDArrayList, NDArray> batchify_fn, Dataset<NDArray> dataset) => throw new NotImplementedException();
