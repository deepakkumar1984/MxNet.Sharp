...
namespace MxNet
{
    public class Model
    {
        ...
        internal static void UpdateParams(List<NDArrayList> param_arrays, List<NDArrayList> grad_arrays,
            Updater updater,
            int num_device, KVStore kvstore, string[] param_names)
        {
            throw new NotImplementedException();
        }
        ...
        internal static void TrainMultiDevice(Symbol symbol, Context ctx, string[] arg_names, string[] param_names,
            string[] aux_names,
            ...
            Func<string, Symbol> sym_gen = null)
        {
            throw new NotImplementedException();
        }
