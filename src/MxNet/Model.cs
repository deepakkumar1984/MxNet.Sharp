...
namespace MxNet
{
    public class Model
    {
        ...
        internal static void InitializeKVStore(KVStore kvstore, List<NDArrayList> param_arrays, NDArrayDict  arg_params, string[] param_names, bool update_on_kvstore) => throw new NotImplementedException();

        internal static void UpdateParamsOnKVStoreNCCL(List<NDArrayList> param_arrays, List<NDArrayList> grad_arrays, KVStore kvstore, string[] param_names) => throw new NotImplementedException();

        internal static void UpdateParamsOnKVStore(List<NDArrayList> param_arrays, List<NDArrayList> grad_arrays, KVStore kvstore, string[] param_names) => throw new NotImplementedException();

        internal static void UpdateParams(List<NDArrayList> param_arrays, List<NDArrayList> grad_arrays, Updater updater, 
