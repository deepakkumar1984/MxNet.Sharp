...
public static NDArray Crop(NDArray data, int x, int y, int width, int height)
{
...
/// <param name="data">Input ndarray</param>
 /// <returns>returns new symbol</returns>
public static NDArray ToTensor(NDArray data)
{
...
/// <param name="std">Sequence of standard deviations for each channel. Default value is 1.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Normalize(NDArray data, Tuple<double> mean=null, Tuple<double> std=null)
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static NDArray FlipLeftRight(NDArray data)
{
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomFlipLeftRight(NDArray data)
{
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static NDArray FlipTopBottom(NDArray data)
{
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomFlipTopBottom(NDArray data)
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomBrightness(NDArray data, float min_factor, float max_factor)
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomContrast(NDArray data, float min_factor, float max_factor)
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomSaturation(NDArray data, float min_factor, float max_factor)
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomHue(NDArray data, float min_factor, float max_factor)
{
...
/// <param name="hue">How much to jitter hue.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomColorJitter(NDArray data, float brightness, float contrast, float saturation, float hue)
{
...
/// <param name="alpha">The lighting alphas for the R, G, B channels.</param>
 /// <returns>returns new symbol</returns>
public static NDArray AdjustLighting(NDArray data, Tuple<double> alpha)
{
...
/// <param name="alpha_std">Level of the lighting noise.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RandomLighting(NDArray data, float alpha_std=0.05f)
{
...
/// <param name="interp">Interpolation method for resizing. By default uses bilinear interpolationOptions are INTER_NEAREST - a nearest-neighbor interpolationINTER_LINEAR - a bilinear interpolationINTER_AREA - resampling using pixel area relationINTER_CUBIC - a bicubic interpolation over 4x4 pixel neighborhoodINTER_LANCZOS4 - a Lanczos interpolation over 8x8 pixel neighborhoodNote that the GPU version only support bilinear interpolation(1) and the result on cpu would be slightly different from gpu.It uses opencv resize function which tend to align center on cpuwhile using contrib.bilinearResize2D which aligns corner on gpu</param>
 /// <returns>returns new symbol</returns>
public static NDArray Resize(NDArray data, NDShape size=null, bool keep_ratio=false, int interp=1)
