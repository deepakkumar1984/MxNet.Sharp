using System;
                                    ...
                                    namespace MxNetLib
                                    {
                                        public partial class SymImgApi
                                        {
                                            ///<summary>
...
///<para>                [ 35 239  50]]]]</para>
///<para>            <NDArray 2x2x2x3 @cpu(0)></para>
///<para> </para>
///<para> </para>
...
public static Symbol Crop(Symbol data, int x, int y, int width, int height, string symbol_name="")
{
...
///<para>            <NDArray 2x3x4x2 @cpu(0)></para>
///<para> </para>
///<para> </para>
...
/// <param name="data">Input ndarray</param>
 /// <returns>returns new symbol</returns>
public static Symbol ToTensor(Symbol data, string symbol_name="")
{
...
/// <param name="std">Sequence of standard deviations for each channel. Default value is 1.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Normalize(Symbol data, Tuple<double> mean=null, Tuple<double> std=null, string symbol_name="")
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static Symbol FlipLeftRight(Symbol data, string symbol_name="")
{
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomFlipLeftRight(Symbol data, string symbol_name="")
{
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static Symbol FlipTopBottom(Symbol data, string symbol_name="")
{
...
/// <param name="data">The input.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomFlipTopBottom(Symbol data, string symbol_name="")
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomBrightness(Symbol data, float min_factor, float max_factor, string symbol_name="")
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomContrast(Symbol data, float min_factor, float max_factor, string symbol_name="")
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomSaturation(Symbol data, float min_factor, float max_factor, string symbol_name="")
{
...
/// <param name="max_factor">Maximum factor.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomHue(Symbol data, float min_factor, float max_factor, string symbol_name="")
{
...
/// <param name="hue">How much to jitter hue.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomColorJitter(Symbol data, float brightness, float contrast, float saturation, float hue, string symbol_name="")
{
...
/// <param name="alpha">The lighting alphas for the R, G, B channels.</param>
 /// <returns>returns new symbol</returns>
public static Symbol AdjustLighting(Symbol data, Tuple<double> alpha, string symbol_name="")
{
...
/// <param name="alpha_std">Level of the lighting noise.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomLighting(Symbol data, float alpha_std=0.05f, string symbol_name="")
{
...
/// <param name="interp">Interpolation method for resizing. By default uses bilinear interpolationOptions are INTER_NEAREST - a nearest-neighbor interpolationINTER_LINEAR - a bilinear interpolationINTER_AREA - resampling using pixel area relationINTER_CUBIC - a bicubic interpolation over 4x4 pixel neighborhoodINTER_LANCZOS4 - a Lanczos interpolation over 8x8 pixel neighborhoodNote that the GPU version only support bilinear interpolation(1) and the result on cpu would be slightly different from gpu.It uses opencv resize function which tend to align center on cpuwhile using contrib.bilinearResize2D which aligns corner on gpu</param>
 /// <returns>returns new symbol</returns>
public static Symbol Resize(Symbol data, NDShape size=null, bool keep_ratio=false, int interp=1, string symbol_name="")
