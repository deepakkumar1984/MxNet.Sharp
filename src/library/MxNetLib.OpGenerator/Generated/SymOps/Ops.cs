...
/// <param name="values">Fill with value(RGB[A] or gray), up to 4 channels.</param>
 /// <returns>returns new symbol</returns>
public static Symbol CvcopyMakeBorder(Symbol data, int top, int bot, int left, int right, int type=0, Tuple<double> values=null, string symbol_name="")
...
/// <param name="output_mean_var">Output All,normal mean and var</param>
 /// <returns>returns new symbol</returns>
public static Symbol BatchNormV1(Symbol data, Symbol gamma, Symbol beta, float eps=0.001f, float momentum=0.9f, bool fix_gamma=true, bool use_global_stats=false, bool output_mean_var=false, string symbol_name="")
{
...
/// <param name="clip_gradient">Clip gradient to the range of [-clip_gradient, clip_gradient] If clip_gradient <= 0, gradient clipping is turned off. grad = max(min(grad, clip_gradient), -clip_gradient).</param>
 /// <returns>returns new symbol</returns>
public static Symbol MpAdamwUpdate(Symbol weight, Symbol grad, Symbol mean, Symbol var, Symbol weight32, Symbol rescale_grad, float lr, float eta, float beta1=0.9f, float beta2=0.999f, float epsilon=1e-08f, float wd=0f, float clip_gradient=-1f, string symbol_name="")
{
...
/// <param name="clip_gradient">Clip gradient to the range of [-clip_gradient, clip_gradient] If clip_gradient <= 0, gradient clipping is turned off. grad = max(min(grad, clip_gradient), -clip_gradient).</param>
 /// <returns>returns new symbol</returns>
public static Symbol AdamwUpdate(Symbol weight, Symbol grad, Symbol mean, Symbol var, Symbol rescale_grad, float lr, float eta, float beta1=0.9f, float beta2=0.999f, float epsilon=1e-08f, float wd=0f, float clip_gradient=-1f, string symbol_name="")
{
...
/// <param name="remain_locs">The locations of remaining data among the inputs.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Foreach(Symbol fn, Symbol[] data, int num_args, int num_outputs, int num_out_data, Tuple<double> in_state_locs, Tuple<double> in_data_locs, Tuple<double> remain_locs, string symbol_name="")
{
...
/// <param name="func_var_locs">The locations of loop_vars among func's inputs.</param>
 /// <returns>returns new symbol</returns>
public static Symbol WhileLoop(Symbol cond, Symbol func, Symbol[] data, int num_args, int num_outputs, int num_out_data, int max_iterations, Tuple<double> cond_input_locs, Tuple<double> func_input_locs, Tuple<double> func_var_locs, string symbol_name="")
{
...
/// <param name="else_input_locs">The locations of else's inputs in the given inputs.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Cond(Symbol cond, Symbol then_branch, Symbol else_branch, Symbol[] data, int num_args, int num_outputs, Tuple<double> cond_input_locs, Tuple<double> then_input_locs, Tuple<double> else_input_locs, string symbol_name="")
{
...
/// <param name="momentum">The momentum for running average</param>
 /// <returns>returns new symbol</returns>
public static Symbol IdentityAttachKLSparseReg(Symbol data, float sparseness_target=0.1f, float penalty=0.001f, float momentum=0.9f, string symbol_name="")
{
...
/// <param name="cudnn_off">Do not select CUDNN operator, if available</param>
 /// <returns>returns new symbol</returns>
public static Symbol BatchNorm(Symbol data, Symbol gamma, Symbol beta, Symbol moving_mean, Symbol moving_var, double eps=0.001, float momentum=0.9f, bool fix_gamma=true, bool use_global_stats=false, bool output_mean_var=false, int axis=1, bool cudnn_off=false, string symbol_name="")
{
...
/// <param name="layout">Set layout for input, output and weight. Empty for    default layout: NCW for 1d, NCHW for 2d and NCDHW for 3d.NHWC and NDHWC are only supported on GPU.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Convolution(Symbol data, Symbol weight, Symbol bias, NDShape kernel, uint num_filter, NDShape stride=null, NDShape dilate=null, NDShape pad=null, uint num_group=1, ulong workspace=1024, bool no_bias=false, ConvolutionCudnnTune? cudnn_tune=null, bool cudnn_off=false, ConvolutionLayout? layout=null, string symbol_name="")
...
/// <param name="blank_label">Set the label that is reserved for blank label.If "first", 0-th label is reserved, and label values for tokens in the vocabulary are between ``1`` and ``alphabet_size-1``, and the padding mask is ``-1``. If "last", last label value ``alphabet_size-1`` is reserved for blank label instead, and label values for tokens in the vocabulary are between ``0`` and ``alphabet_size-2``, and the padding mask is ``0``.</param>
 /// <returns>returns new symbol</returns>
public static Symbol CTCLoss(Symbol data, Symbol label, Symbol data_lengths, Symbol label_lengths, bool use_data_lengths=false, bool use_label_lengths=false, CtclossBlankLabel blank_label=CtclossBlankLabel.First, string symbol_name="")
{
...
///<summary>
///<para>Computes 1D or 2D transposed convolution (aka fractionally strided convolution) of the input tensor. This operation can be seen as the gradient of Convolution operation with respect to its input. Convolution usually reduces the size of the input. Transposed convolution works the other way, going from a smaller input to a larger output while preserving the connectivity pattern.</para>
///</summary>
...
/// <param name="layout">Set layout for input, output and weight. Empty for default layout, NCW for 1d, NCHW for 2d and NCDHW for 3d.NHWC and NDHWC are only supported on GPU.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Deconvolution(Symbol data, Symbol weight, Symbol bias, NDShape kernel, uint num_filter, NDShape stride=null, NDShape dilate=null, NDShape pad=null, NDShape adj=null, NDShape target_shape=null, uint num_group=1, ulong workspace=512, bool no_bias=true, DeconvolutionCudnnTune? cudnn_tune=null, bool cudnn_off=false, DeconvolutionLayout? layout=null, string symbol_name="")
{if(stride==null){ stride= new NDShape();}
if(dilate==null){ dilate= new NDShape();}
if(pad==null){ pad= new NDShape();}
if(adj==null){ adj= new NDShape();}
if(target_shape==null){ target_shape= new NDShape();}
...
/// <param name="cudnn_off">Whether to turn off cudnn in dropout operator. This option is ignored if axes is specified.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Dropout(Symbol data, float p=0.5f, DropoutMode mode=DropoutMode.Training, NDShape axes=null, bool? cudnn_off=false, string symbol_name="")
{if(axes==null){ axes= new NDShape();}
...
/// <param name="output_mean_var">Output the mean and std calculated along the given axis.</param>
 /// <returns>returns new symbol</returns>
public static Symbol LayerNorm(Symbol data, Symbol gamma, Symbol beta, int axis=-1, float eps=1e-05f, bool output_mean_var=false, string symbol_name="")
{
...
///<para> </para>
///<para>.. math::</para>
///<para>   b_{x,y}^{i} = \frac{a_{x,y}^{i}}{\Bigg({k + \frac{\alpha}{n} \sum_{j=max(0, i-\frac{n}{2})}^{min(N-1, i+\frac{n}{2})} (a_{x,y}^{j})^{2}}\Bigg)^{\beta}}</para>
///<para> </para>
///<para>where the sum runs over :math:`n` "adjacent" kernel maps at the same spatial position, and :math:`N` is the total</para>
...
/// <param name="nsize">normalization window width in elements.</param>
 /// <returns>returns new symbol</returns>
public static Symbol LRN(Symbol data, uint nsize, float alpha=0.0001f, float beta=0.75f, float knorm=2f, string symbol_name="")
{
...
private static readonly List<string> PoolingPoolingConventionConvert = new List<string>(){"full","same","valid"};
private static readonly List<string> PoolingLayoutConvert = new List<string>(){"NCDHW","NCHW","NCW","NDHWC","NHWC","NWC"};
///<summary>
...
/// <param name="layout">Set layout for input and output. Empty for    default layout: NCW for 1d, NCHW for 2d and NCDHW for 3d.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Pooling(Symbol data, NDShape kernel=null, PoolingPoolType pool_type=PoolingPoolType.Max, bool global_pool=false, bool cudnn_off=false, PoolingPoolingConvention pooling_convention=PoolingPoolingConvention.Valid, NDShape stride=null, NDShape pad=null, int? p_value=null, bool? count_include_pad=null, PoolingLayout? layout=null, string symbol_name="")
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to the same as input's dtype if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol Softmax(Symbol data, int axis=-1, double? temperature=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to the same as input's dtype if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol Softmin(Symbol data, int axis=-1, double? temperature=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to the same as input's dtype if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol LogSoftmax(Symbol data, int axis=-1, double? temperature=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="mode">Specifies how to compute the softmax. If set to ``instance``, it computes softmax for each instance. If set to ``channel``, It computes cross channel softmax for each position of each instance.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SoftmaxActivation(Symbol data, SoftmaxactivationMode mode=SoftmaxactivationMode.Instance, string symbol_name="")
{
...
///<summary>
///<para>Performs nearest neighbor/bilinear up sampling to inputs. Bilinear upsampling makes use of deconvolution. Therefore, provide 2 inputs - data and weight. </para>
///</summary>
...
/// <param name="num_filter">Input filter. Only used by bilinear sample_type.Since bilinear upsampling uses deconvolution, num_filters is set to the number of channels.</param>
...
/// <param name="workspace">Tmp workspace for deconvolution (MB)</param>
 /// <returns>returns new symbol</returns>
public static Symbol UpSampling(Symbol[] data, int scale, UpsamplingSampleType sample_type, int num_args, int num_filter=0, UpsamplingMultiInputMode multi_input_mode=UpsamplingMultiInputMode.Concat, ulong workspace=512, string symbol_name="")
{
...
/// <param name="clip_gradient">Clip gradient to the range of [-clip_gradient, clip_gradient] If clip_gradient <= 0, gradient clipping is turned off. grad = max(min(grad, clip_gradient), -clip_gradient).</param>
 /// <returns>returns new symbol</returns>
public static Symbol SignsgdUpdate(Symbol weight, Symbol grad, float lr, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, string symbol_name="")
{
...
/// <param name="wd_lh">The amount of weight decay that does not go into gradient/momentum calculationsotherwise do weight decay algorithmically only.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SignumUpdate(Symbol weight, Symbol grad, Symbol mom, float lr, float momentum=0f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, float wd_lh=0f, string symbol_name="")
{
...
/// <param name="num_weights">Number of updated weights.</param>
 /// <returns>returns new symbol</returns>
public static Symbol MultiSgdUpdate(Symbol[] data, Tuple<double> lrs, Tuple<double> wds, float rescale_grad=1f, float clip_gradient=-1f, int num_weights=1, string symbol_name="")
{
...
/// <param name="num_weights">Number of updated weights.</param>
 /// <returns>returns new symbol</returns>
public static Symbol MultiSgdMomUpdate(Symbol[] data, Tuple<double> lrs, Tuple<double> wds, float momentum=0f, float rescale_grad=1f, float clip_gradient=-1f, int num_weights=1, string symbol_name="")
{
...
/// <param name="num_weights">Number of updated weights.</param>
 /// <returns>returns new symbol</returns>
public static Symbol MultiMpSgdUpdate(Symbol[] data, Tuple<double> lrs, Tuple<double> wds, float rescale_grad=1f, float clip_gradient=-1f, int num_weights=1, string symbol_name="")
{
...
/// <param name="num_weights">Number of updated weights.</param>
 /// <returns>returns new symbol</returns>
public static Symbol MultiMpSgdMomUpdate(Symbol[] data, Tuple<double> lrs, Tuple<double> wds, float momentum=0f, float rescale_grad=1f, float clip_gradient=-1f, int num_weights=1, string symbol_name="")
{
...
/// <param name="lazy_update">If true, lazy updates are applied if gradient's stype is row_sparse.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SgdUpdate(Symbol weight, Symbol grad, float lr, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, bool lazy_update=true, string symbol_name="")
{
...
/// <param name="lazy_update">If true, lazy updates are applied if gradient's stype is row_sparse and both weight and momentum have the same stype</param>
 /// <returns>returns new symbol</returns>
public static Symbol SgdMomUpdate(Symbol weight, Symbol grad, Symbol mom, float lr, float momentum=0f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, bool lazy_update=true, string symbol_name="")
{
...
/// <param name="lazy_update">If true, lazy updates are applied if gradient's stype is row_sparse.</param>
 /// <returns>returns new symbol</returns>
public static Symbol MpSgdUpdate(Symbol weight, Symbol grad, Symbol weight32, float lr, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, bool lazy_update=true, string symbol_name="")
{
...
/// <param name="lazy_update">If true, lazy updates are applied if gradient's stype is row_sparse and both weight and momentum have the same stype</param>
 /// <returns>returns new symbol</returns>
public static Symbol MpSgdMomUpdate(Symbol weight, Symbol grad, Symbol mom, Symbol weight32, float lr, float momentum=0f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, bool lazy_update=true, string symbol_name="")
{
...
/// <param name="clip_grad">Clip gradient to the range of [-clip_gradient, clip_gradient] If clip_gradient <= 0, gradient clipping is turned off. grad = max(min(grad, clip_gradient), -clip_gradient).</param>
 /// <returns>returns new symbol</returns>
public static Symbol FtmlUpdate(Symbol weight, Symbol grad, Symbol d, Symbol v, Symbol z, float lr, int t, float beta1=0.6f, float beta2=0.999f, double epsilon=1e-08, float wd=0f, float rescale_grad=1f, float clip_grad=-1f, string symbol_name="")
{
...
/// <param name="lazy_update">If true, lazy updates are applied if gradient's stype is row_sparse and all of w, m and v have the same stype</param>
 /// <returns>returns new symbol</returns>
public static Symbol AdamUpdate(Symbol weight, Symbol grad, Symbol mean, Symbol var, float lr, float beta1=0.9f, float beta2=0.999f, float epsilon=1e-08f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, bool lazy_update=true, string symbol_name="")
{
...
/// <param name="clip_weights">Clip weights to the range of [-clip_weights, clip_weights] If clip_weights <= 0, weight clipping is turned off. weights = max(min(weights, clip_weights), -clip_weights).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RmspropUpdate(Symbol weight, Symbol grad, Symbol n, float lr, float gamma1=0.95f, float epsilon=1e-08f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, float clip_weights=-1f, string symbol_name="")
{
...
/// <param name="clip_weights">Clip weights to the range of [-clip_weights, clip_weights] If clip_weights <= 0, weight clipping is turned off. weights = max(min(weights, clip_weights), -clip_weights).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RmspropalexUpdate(Symbol weight, Symbol grad, Symbol n, Symbol g, Symbol delta, float lr, float gamma1=0.95f, float gamma2=0.9f, float epsilon=1e-08f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, float clip_weights=-1f, string symbol_name="")
{
...
///<para>     z[row] += rescaled_grad[row] - (sqrt(n[row] + rescaled_grad[row]**2) - sqrt(n[row])) * weight[row] / learning_rate</para>
///<para>     n[row] += rescaled_grad[row]**2</para>
///<para>     w[row] = (sign(z[row]) * lamda1 - z[row]) / ((beta + sqrt(n[row])) / learning_rate + wd) * (abs(z[row]) > lamda1)</para>
///<para> </para>
///<para> </para>
///<para> </para>
...
/// <param name="clip_gradient">Clip gradient to the range of [-clip_gradient, clip_gradient] If clip_gradient <= 0, gradient clipping is turned off. grad = max(min(grad, clip_gradient), -clip_gradient).</param>
 /// <returns>returns new symbol</returns>
public static Symbol FtrlUpdate(Symbol weight, Symbol grad, Symbol z, Symbol n, float lr, float lamda1=0.01f, float beta=1f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, string symbol_name="")
{
...
/// <param name="clip_gradient">Clip gradient to the range of [-clip_gradient, clip_gradient] If clip_gradient <= 0, gradient clipping is turned off. grad = max(min(grad, clip_gradient), -clip_gradient).</param>
 /// <returns>returns new symbol</returns>
public static Symbol SparseAdagradUpdate(Symbol weight, Symbol grad, Symbol history, float lr, float epsilon=1e-07f, float wd=0f, float rescale_grad=1f, float clip_gradient=-1f, string symbol_name="")
{
...
/// <param name="constant_value">The value used for padding when `mode` is "constant".</param>
 /// <returns>returns new symbol</returns>
public static Symbol Pad(Symbol data, PadMode mode, NDShape pad_width, double constant_value=0, string symbol_name="")
{
...
/// <param name="high">Upper bounds of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleUniform(Symbol low, Symbol high, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="sigma">Standard deviations of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleNormal(Symbol mu, Symbol sigma, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="beta">Beta (scale) parameters of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleGamma(Symbol alpha, Symbol beta, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleExponential(Symbol lam, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol SamplePoisson(Symbol lam, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="p">Failure probabilities in each experiment.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleNegativeBinomial(Symbol k, Symbol p, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="alpha">Alpha (dispersion) parameters of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleGeneralizedNegativeBinomial(Symbol mu, Symbol alpha, NDShape shape=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleMultinomial(Symbol data, NDShape shape=null, bool get_prob=false, DType dtype=null, string symbol_name="")
{if(shape==null){ shape= new NDShape();}
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomUniform(float low=0f, float high=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomNormal(float loc=0f, float scale=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomGamma(float alpha=1f, float beta=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomExponential(float lam=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomPoisson(float lam=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomNegativeBinomial(int k=1, float p=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomGeneralizedNegativeBinomial(float mu=1f, float alpha=1f, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to int32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomRandint(Tuple<double> low, Tuple<double> high, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{
...
/// <param name="data">The input</param>
 /// <returns>returns new symbol</returns>
public static Symbol RandomGeneralizedNegativeBinomialLike(Symbol data, float mu=1f, float alpha=1f, string symbol_name="")
{
...
/// <param name="shape">2-D shape of the output, where shape[0] is the batch size, and shape[1] is the number of candidates to sample for each batch.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SampleUniqueZipfian(int range_max, NDShape shape=null, string symbol_name="")
{
...
///<para> </para>
///<para>If :math:`\hat{y}_i` is the predicted value of the i-th sample, and :math:`y_i` is the corresponding target value,</para>
///<para>then the squared loss estimated over :math:`n` samples is defined as</para>
///<para> </para>
///<para>:math:`\text{SquaredLoss}(\textbf{Y}, \hat{\textbf{Y}} ) = \frac{1}{n} \sum_{i=0}^{n-1} \lVert  \textbf{y}_i - \hat{\textbf{y}}_i  \rVert_2`</para>
///<para> </para>
///<para>.. note::</para>
...
///<para> </para>
///<para>By default, gradients of this loss function are scaled by factor `1/m`, where m is the number of regression outputs of a training example.</para>
...
/// <param name="grad_scale">Scale the gradient by a float factor</param>
 /// <returns>returns new symbol</returns>
public static Symbol LinearRegressionOutput(Symbol data, Symbol label, float grad_scale=1f, string symbol_name="")
{
...
///<para> </para>
///<para>:math:`\text{MAE}(\textbf{Y}, \hat{\textbf{Y}} ) = \frac{1}{n} \sum_{i=0}^{n-1} \lVert \textbf{y}_i - \hat{\textbf{y}}_i \rVert_1`</para>
///<para> </para>
///<para>.. note::</para>
...
/// <param name="grad_scale">Scale the gradient by a float factor</param>
 /// <returns>returns new symbol</returns>
public static Symbol MAERegressionOutput(Symbol data, Symbol label, float grad_scale=1f, string symbol_name="")
{
...
///<para> </para>
///<para>Where `y` is the ground truth probability of positive outcome for a given example, and `p` the probability predicted by the model. By default, gradients of this loss function are scaled by factor `1/m`, where m is the number of regression outputs of a training example.</para>
///<para>The parameter `grad_scale` can be used to change this scale to `grad_scale/m`.</para>
///<para> </para>
///<para> </para>
///<para> </para>
...
/// <param name="grad_scale">Scale the gradient by a float factor</param>
 /// <returns>returns new symbol</returns>
public static Symbol LogisticRegressionOutput(Symbol data, Symbol label, float grad_scale=1f, string symbol_name="")
{
...
/// <param name="lstm_state_clip_nan">Whether to stop NaN from propagating in state by clipping it to min/max. If clipping range is not specified, this option is ignored.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RNN(Symbol data, Symbol parameters, Symbol state, Symbol state_cell, uint state_size, uint num_layers, RNNMode mode, bool bidirectional=false, float p=0f, bool state_outputs=false, int? projection_size=null, double? lstm_state_clip_min=null, double? lstm_state_clip_max=null, bool lstm_state_clip_nan=false, string symbol_name="")
{
...
/// <param name="mode">Specify how out-of-bound indices behave. Default is "clip". "clip" means clip to the range. So, if all indices mentioned are too large, they are replaced by the index that addresses the last element along an axis.  "wrap" means to wrap around.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Pick(Symbol data, Symbol index, int? axis=-1, bool keepdims=false, PickMode mode=PickMode.Clip, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Sum(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Mean(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Prod(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Nansum(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Nanprod(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Max(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Min(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
/// <param name="size">Target sizes of the broadcasting axes.</param>
 /// <returns>returns new symbol</returns>
public static Symbol BroadcastAxis(Symbol data, NDShape axis=null, NDShape size=null, string symbol_name="")
{if(axis==null){ axis= new NDShape();}
if(size==null){ size= new NDShape();}
...
///<para>Also see, `Broadcasting <https://docs.scipy.org/doc/numpy/user/basics.broadcasting.html>`_ for more explanation.</para>
///<para> </para>
///<para>Broadcasting is allowed on axes with size 1, such as from `(2,1,3,1)` to</para>
///<para>`(2,8,3,9)`. Elements will be duplicated on the broadcasted axes.</para>
///<para> </para>
...
/// <param name="shape">The shape of the desired array. We can set the dim to zero if it's same as the original. E.g `A = broadcast_to(B, shape=(10, 0, 0))` has the same meaning as `A = broadcast_axis(B, axis=0, size=10)`.</param>
 /// <returns>returns new symbol</returns>
public static Symbol BroadcastTo(Symbol data, NDShape shape=null, string symbol_name="")
{if(shape==null){ shape= new NDShape();}
...
/// <param name="rhs_axes">Axes to copy from the second input array</param>
 /// <returns>returns new symbol</returns>
public static Symbol BroadcastLike(Symbol lhs, Symbol rhs, NDShape lhs_axes=null, NDShape rhs_axes=null, string symbol_name="")
{
...
/// <param name="keepdims">If this is set to `True`, the reduced axis is left in the result as dimension with size one.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Norm(Symbol data, int ord=2, NDShape axis=null, NormOutDtype? out_dtype=null, bool keepdims=false, string symbol_name="")
{
...
/// <param name="forward_stype">The desired storage type of the forward output given by user, if thecombination of input storage types and this hint does not matchany implemented ones, the dot operator will perform fallback operationand still produce an output of the desired storage type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Dot(Symbol lhs, Symbol rhs, bool transpose_a=false, bool transpose_b=false, DotForwardStype? forward_stype=null, string symbol_name="")
{
...
/// <param name="forward_stype">The desired storage type of the forward output given by user, if thecombination of input storage types and this hint does not matchany implemented ones, the dot operator will perform fallback operationand still produce an output of the desired storage type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol BatchDot(Symbol lhs, Symbol rhs, bool transpose_a=false, bool transpose_b=false, BatchDotForwardStype? forward_stype=null, string symbol_name="")
{
...
///<summary>
///<para>Returns the result of element-wise **lesser than or equal to** (<=) comparison operation with broadcasting.</para>
///<para> </para>
///<para>Example::</para>
///<para> </para>
///<para>   x = [[ 1.,  1.,  1.],</para>
...
///<para>    (\sigma x)^2/2,& \text{if }x < 1/\sigma^2\\</para>
...
///<para>  Examples::</para>
///<para> </para>
///<para>  - lhs shape = (30,7), rhs shape = (15,2,4), lhs_begin=0, lhs_end=1, rhs_begin=0, rhs_end=2, output shape = (15,2,7)</para>
///<para>  - lhs shape = (3, 5), rhs shape = (1,15,4), lhs_begin=0, lhs_end=2, rhs_begin=1, rhs_end=2, output shape = (15)</para>
///<para> </para>
///<para>Negative indices are supported, and `None` can be used for either `lhs_end` or `rhs_end` to indicate the end of the range.</para>
///<para> </para>
///<para>  Example::</para>
///<para> </para>
///<para>  - lhs shape = (30, 12), rhs shape = (4, 2, 2, 3), lhs_begin=-1, lhs_end=None, rhs_begin=1, rhs_end=None, output shape = (30, 2, 2, 3)</para>
///<para> </para>
///<para> </para>
///<para> </para>
...
/// <param name="rhs_end">Defaults to None. The ending index along which the rhs dimensions are to be used for reshaping. Supports negative indices.</param>
 /// <returns>returns new symbol</returns>
public static Symbol ShapeArray(Symbol data, int? lhs_begin=null, int? lhs_end=null, int? rhs_begin=null, int? rhs_end=null, string symbol_name="")
{
...
///<para> </para>
///<para>The floor of the scalar x is the largest integer i, such that i <= x.</para>
///<para> </para>
///<para>Example::</para>
///<para> </para>
...
/// <param name="range">The lower and upper range of the bins. if not provided, range is simply (a.min(), a.max()). values outside the range are ignored. the first element of the range must be less than or equal to the second. range affects the automatic bin computation as well. while bin width is computed to be optimal based on the actual data within range, the bin count will fill the entire range including portions containing no data.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Histogram(Symbol data, Symbol bins, int? bin_cnt=null, Tuple<double> range=null, string symbol_name="")
{
...
/// <param name="sparse_grad">Compute row sparse gradient in the backward calculation. If set to True, the grad's storage type is row_sparse.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Embedding(Symbol data, Symbol weight, int input_dim, int output_dim, DType dtype=null, bool sparse_grad=false, string symbol_name="")
...
/// <param name="mode">Specify how out-of-bound indices bahave. Default is "clip". "clip" means clip to the range. So, if all indices mentioned are too large, they are replaced by the index that addresses the last element along an axis.  "wrap" means to wrap around.  "raise" means to raise an error, not supported yet.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Take(Symbol a, Symbol indices, int axis=0, TakeMode mode=TakeMode.Clip, string symbol_name="")
{
...
/// <param name="dtype">DType of the output</param>
 /// <returns>returns new symbol</returns>
public static Symbol OneHot(Symbol indices, int depth, double on_value=1, double off_value=0, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
///<para>where `M <= N`. If `M == N`, output shape will simply be `(Y_0, ..., Y_{K-1})`.</para>
///<para> </para>
...
///<para>where `M <= N`. If `M == N`, data shape should simply be `(Y_0, ..., Y_{K-1})`.</para>
///<para> </para>
///<para>The elements in output is defined as follows::</para>
///<para> </para>
...
/// <param name="shape">Shape of output.</param>
 /// <returns>returns new symbol</returns>
public static Symbol ScatterNd(Symbol data, Symbol indices, NDShape shape, string symbol_name="")
{
...
/// <param name="shape">Shape of output.</param>
 /// <returns>returns new symbol</returns>
public static Symbol ScatterSetNd(Symbol lhs, Symbol rhs, Symbol indices, NDShape shape, string symbol_name="")
{
...
/// <param name="dtype">Target data type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol ZerosWithoutDtype(NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="dtype">Target data type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Zeros(NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{if(shape==null){ shape= new NDShape();}
if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="dtype">Target data type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Eye(Tuple<double> N, int M=0, int k=0, Context ctx=null, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="dtype">Target data type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Ones(NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{if(shape==null){ shape= new NDShape();}
if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="value">Value with which to fill newly created tensor</param>
 /// <returns>returns new symbol</returns>
public static Symbol Full(double value, NDShape shape=null, Context ctx=null, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="dtype">Target data type.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Arange(double start, double? stop=null, double step=1, int repeat=1, bool infer_range=false, Context ctx=null, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="axis">Axis corresponding to the matrix rows.</param>
 /// <returns>returns new symbol</returns>
public static Symbol LinalgGemm(Symbol A, Symbol B, Symbol C, bool transpose_a=false, bool transpose_b=false, double alpha=1, double beta=1, int axis=-2, string symbol_name="")
{
...
/// <param name="axis">Axis corresponding to the matrix row indices.</param>
 /// <returns>returns new symbol</returns>
public static Symbol LinalgGemm2(Symbol A, Symbol B, bool transpose_a=false, bool transpose_b=false, double alpha=1, int axis=-2, string symbol_name="")
{
...
/// <param name="alpha">Scalar factor to be applied to the result.</param>
 /// <returns>returns new symbol</returns>
public static Symbol LinalgTrmm(Symbol A, Symbol B, bool transpose=false, bool rightside=false, bool lower=true, double alpha=1, string symbol_name="")
{
...
/// <param name="alpha">Scalar factor to be applied to the result.</param>
 /// <returns>returns new symbol</returns>
public static Symbol LinalgTrsm(Symbol A, Symbol B, bool transpose=false, bool rightside=false, bool lower=true, double alpha=1, string symbol_name="")
{
...
///<para>must have shape *(x, y)* with *x <= y*, and must have full rank *=x*. The LQ</para>
...
///<para> </para>
///<para>where *I* is the identity matrix. Also, *L(0) <= L(1) <= L(2) <= ...* (ascending order).</para>
///<para> </para>
...
///<para>The shape is a tuple of integers such as (2,3,4). The size of the new shape should be same as the size of the input array.</para>
///<para> </para>
///<para>Example::</para>
///<para> </para>
///<para>  reshape([1,2,3,4], shape=(2,2)) = [[1,2], [3,4]]</para>
///<para> </para>
///<para>Some dimensions of the shape can take special values from the set {0, -1, -2, -3, -4}. The significance of each is explained below:</para>
///<para> </para>
...
///<para> </para>
///<para>- ``-4`` split one dimension of the input into two dimensions passed subsequent to -4 in shape (can contain -1).</para>
///<para> </para>
///<para>  Example::</para>
///<para> </para>
...
/// <param name="reverse">If true then the special values are inferred from right to left</param>
 /// <returns>returns new symbol</returns>
public static Symbol Reshape(Symbol data, NDShape shape=null, bool reverse=false, string symbol_name="")
{if(shape==null){ shape= new NDShape();}
...
/// <param name="axes">Target axis order. By default the axes will be inverted.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Transpose(Symbol data, NDShape axes=null, string symbol_name="")
{if(axes==null){ axes= new NDShape();}
...
///<para>where m <= n, results in an array with the shape</para>
...
/// <param name="step">step for the slice operation, supports negative values.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Slice(Symbol data, NDShape begin, NDShape end, NDShape step=null, string symbol_name="")
{if(step==null){ step= new NDShape();}
...
/// <param name="step">step for the slice operation, supports negative values.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SliceAssign(Symbol lhs, Symbol rhs, NDShape begin, NDShape end, NDShape step=null, string symbol_name="")
{if(step==null){ step= new NDShape();}
...
/// <param name="step">step for the slice operation, supports negative values.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SliceAssignScalar(Symbol data, NDShape begin, NDShape end, double scalar=0, NDShape step=null, string symbol_name="")
{if(step==null){ step= new NDShape();}
...
/// <param name="axes">List of axes on which input data will be sliced according to the corresponding size of the second input. By default will slice on all axes. Negative axes are supported.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SliceLike(Symbol data, Symbol shape_like, NDShape axes=null, string symbol_name="")
{if(axes==null){ axes= new NDShape();}
...
///<para>   - clip(row_sparse, a_min <= 0, a_max >= 0) = row_sparse</para>
...
/// <param name="reps">The number of times for repeating the tensor a. Each dim size of reps must be a positive integer. If reps has length d, the result will have dimension of max(d, a.ndim); If a.ndim < d, a is promoted to be d-dimensional by prepending new axes. If a.ndim > d, reps is promoted to a.ndim by pre-pending 1's to it.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Tile(Symbol data, NDShape reps, string symbol_name="")
{
...
/// <param name="axis">The axis which to reverse elements.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Reverse(Symbol data, NDShape axis, string symbol_name="")
{
...
/// <param name="axis">Selects a subset of the single-dimensional entries in the shape. If an axis is selected with shape entry greater than one, an error is raised.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Squeeze(Symbol[] data, NDShape axis=null, string symbol_name="")
{
...
///<para>    x \prime = reshape(x, [N, block\_size, block\_size, C / (block\_size ^ 2), H * block\_size, W * block\_size]) \\</para>
...
///<para> </para>
///<para>where :math:`x` is an input tensor with default layout as :math:`[N, C, H, W]`: [batch, channels, height, width] </para>
///<para>and :math:`y` is the output tensor of layout :math:`[N, C / (block\_size ^ 2), H * block\_size, W * block\_size]`</para>
///<para> </para>
///<para>Example::</para>
///<para> </para>
///<para>  x = [[[[0, 1, 2],</para>
...
/// <param name="sections">Number of sections if equally splitted. Default to 0 which means split by indices.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SplitV2(Symbol data, NDShape indices, int axis=1, bool squeeze_axis=false, int sections=0, string symbol_name="")
{
...
/// <param name="dtype">DType of the output indices when ret_typ is "indices" or "both". An error will be raised if the selected data type cannot precisely represent the indices.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Topk(Symbol data, int? axis=-1, int k=1, TopkRetTyp ret_typ=TopkRetTyp.Indices, bool is_ascend=false, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
/// <param name="dtype">DType of the output indices. It is only valid when ret_typ is "indices" or "both". An error will be raised if the selected data type cannot precisely represent the indices.</param>
 /// <returns>returns new symbol</returns>
public static Symbol Argsort(Symbol data, int? axis=-1, bool is_ascend=true, DType dtype=null, string symbol_name="")
{if(dtype==null){ dtype= DType.Float32;}
...
///<summary>
///<para>Converts a batch of index arrays into an array of flat indices. The operator follows numpy conventions so a single multi index is given by a column of the input matrix. The leading dimension may be left unspecified by using -1 as placeholder.  </para>
///<para> </para>
///<para>Examples::</para>
///<para> </para>
...
/// <param name="shape">Shape of the array into which the multi-indices apply.</param>
 /// <returns>returns new symbol</returns>
public static Symbol RavelMultiIndex(Symbol data, NDShape shape=null, string symbol_name="")
{
...
///<summary>
///<para>Converts an array of flat indices into a batch of index arrays. The operator follows numpy conventions so a single multi index is given by a column of the output matrix. The leading dimension may be left unspecified by using -1 as placeholder.  </para>
///<para> </para>
///<para>Examples::</para>
///<para> </para>
...
/// <param name="shape">Shape of the array into which the multi-indices apply.</param>
 /// <returns>returns new symbol</returns>
public static Symbol UnravelIndex(Symbol data, NDShape shape=null, string symbol_name="")
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SquareSum(Symbol data, NDShape axis=null, bool keepdims=false, bool exclude=false, string symbol_name="")
{
...
///<para> </para>
///<para>Bilinear Sampling is the key of  [NIPS2015] \"Spatial Transformer Networks\". The usage of the operator is very similar to remap function in OpenCV,</para>
...
///<para> </para>
///<para>:math:`x_{dst}`, :math:`y_{dst}` enumerate all spatial locations in :math:`output`, and :math:`G()` denotes the bilinear interpolation kernel.</para>
///<para>The out-boundary points will be padded with zeros.The shape of the output will be (data.shape[0], data.shape[1], grid.shape[2], grid.shape[3]).</para>
///<para> </para>
...
///<para>If users want to design a CustomOp to manipulate :math:`grid`, please firstly refer to the code of GridGenerator.</para>
///<para> </para>
///<para>Example 1::</para>
///<para> </para>
...
/// <param name="layout">Set layout for input, output and weight. Empty for    default layout: NCHW for 2d and NCDHW for 3d.</param>
 /// <returns>returns new symbol</returns>
public static Symbol ConvolutionV1(Symbol data, Symbol weight, Symbol bias, NDShape kernel, uint num_filter, NDShape stride=null, NDShape dilate=null, NDShape pad=null, uint num_group=1, ulong workspace=1024, bool no_bias=false, ConvolutionV1CudnnTune? cudnn_tune=null, bool cudnn_off=false, ConvolutionV1Layout? layout=null, string symbol_name="")
{if(stride==null){ stride= new NDShape();}
if(dilate==null){ dilate= new NDShape();}
if(pad==null){ pad= new NDShape();}
...
///<para> </para>
///<para>Given two multi-channel feature maps :math:`f_{1}, f_{2}`, with :math:`w`, :math:`h`, and :math:`c` being their width, height, and number of channels,</para>
///<para>the correlation layer lets the network compare each patch from :math:`f_{1}` with each patch from :math:`f_{2}`.</para>
///<para> </para>
///<para>For now we consider only a single comparison of two patches. The 'correlation' of two patches centered at :math:`x_{1}` in the first map and</para>
...
///<para> </para>
///<para>Note that the equation above is identical to one step of a convolution in neural networks, but instead of convolving data with a filter, it convolves data with other</para>
///<para>data. For this reason, it has no training weights.</para>
///<para> </para>
///<para>Computing :math:`c(x_{1}, x_{2})` involves :math:`c * K^{2}` multiplications. Comparing all patch combinations involves :math:`w^{2}*h^{2}` such computations.</para>
///<para> </para>
///<para>Given a maximum displacement :math:`d`, for each location :math:`x_{1}` it computes correlations :math:`c(x_{1}, x_{2})` only in a neighborhood of size :math:`D:=2d+1`,</para>
///<para>by limiting the range of :math:`x_{2}`. We use strides :math:`s_{1}, s_{2}`, to quantize :math:`x_{1}` globally and to quantize :math:`x_{2}` within the neighborhood</para>
...
///<para> </para>
///<para>where :math:`i` and :math:`j` enumerate spatial locations in :math:`f_{1}`, and :math:`q` denotes the :math:`q^{th}` neighborhood of :math:`x_{i,j}`.</para>
///<para> </para>
///<para> </para>
...
/// <param name="is_multiply">operation type is either multiplication or subduction</param>
 /// <returns>returns new symbol</returns>
public static Symbol Correlation(Symbol data1, Symbol data2, uint kernel_size=1, uint max_displacement=1, uint stride1=1, uint stride2=1, uint pad_size=0, bool is_multiply=true, string symbol_name="")
{
...
/// <param name="center_crop">If set to true, then it will use be the center_crop,or it will crop using the shape of crop_like</param>
 /// <returns>returns new symbol</returns>
public static Symbol Crop(List<Symbol> data, int num_args, NDShape offset=null, NDShape h_w=null, bool center_crop=false, string symbol_name="")
{if(offset==null){ offset= new NDShape();}
if(h_w==null){ h_w= new NDShape();}
...
/// <param name="target_shape">Specifies the output shape (H, W). This is required if transformation type is `affine`. If transformation type is `warp`, this parameter is ignored.</param>
 /// <returns>returns new symbol</returns>
public static Symbol GridGenerator(Symbol data, GridgeneratorTransformType transform_type, NDShape target_shape=null, string symbol_name="")
{if(target_shape==null){ target_shape= new NDShape();}
...
/// <param name="eps">An `epsilon` parameter to prevent division by 0.</param>
 /// <returns>returns new symbol</returns>
public static Symbol InstanceNorm(Symbol data, Symbol gamma, Symbol beta, float eps=0.001f, string symbol_name="")
{
...
///<para>    for i in 0...N</para>
///<para>      out[.....,i,...] = take(out, indices=i, axis=dim) / sqrt(sum(take(out, indices=i, axis=dim) ** 2) + eps)</para>
///<para>          -dim-</para>
///<para> </para>
///<para>Example::</para>
///<para> </para>
...
/// <param name="mode">Specify the dimension along which to compute L2 norm.</param>
 /// <returns>returns new symbol</returns>
public static Symbol L2Normalization(Symbol data, float eps=1e-10f, L2normalizationMode mode=L2normalizationMode.Instance, string symbol_name="")
{
...
/// <param name="normalization">If this is set to null, the output gradient will not be normalized. If this is set to batch, the output gradient will be divided by the batch size. If this is set to valid, the output gradient will be divided by the number of valid input elements.</param>
 /// <returns>returns new symbol</returns>
public static Symbol MakeLoss(Symbol data, float grad_scale=1f, float valid_thresh=0f, MakelossNormalization normalization=MakelossNormalization.Null, string symbol_name="")
{
...
/// <param name="pad">pad for pooling: (y, x) or (d, y, x)</param>
 /// <returns>returns new symbol</returns>
public static Symbol PoolingV1(Symbol data, NDShape kernel=null, PoolingV1PoolType pool_type=PoolingV1PoolType.Max, bool global_pool=false, PoolingV1PoolingConvention pooling_convention=PoolingV1PoolingConvention.Valid, NDShape stride=null, NDShape pad=null, string symbol_name="")
{if(kernel==null){ kernel= new NDShape();}
if(stride==null){ stride= new NDShape();}
if(pad==null){ pad= new NDShape();}
...
/// <param name="spatial_scale">Ratio of input feature map height (or w) to raw image height (or w). Equals the reciprocal of total stride in convolutional layers</param>
 /// <returns>returns new symbol</returns>
public static Symbol ROIPooling(Symbol data, Symbol rois, NDShape pooled_size, float spatial_scale, string symbol_name="")
{
...
/// <param name="axis">The sequence axis. Only values of 0 and 1 are currently supported.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SequenceLast(Symbol data, Symbol sequence_length, bool use_sequence_length=false, int axis=0, string symbol_name="")
{
...
/// <param name="axis">The sequence axis. Only values of 0 and 1 are currently supported.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SequenceMask(Symbol data, Symbol sequence_length, bool use_sequence_length=false, float value=0f, int axis=0, string symbol_name="")
{
...
///<para> </para>
///<para>This function takes an n-dimensional input array of the form [max_sequence_length, batch_size, other_feature_dims]</para>
...
/// <param name="axis">The sequence axis. Only 0 is currently supported.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SequenceReverse(Symbol data, Symbol sequence_length, bool use_sequence_length=false, int axis=0, string symbol_name="")
{
...
/// <param name="cudnn_off">whether to turn cudnn off</param>
 /// <returns>returns new symbol</returns>
public static Symbol SpatialTransformer(Symbol data, Symbol loc, SpatialtransformerTransformType transform_type, SpatialtransformerSamplerType sampler_type, NDShape target_shape=null, bool? cudnn_off=null, string symbol_name="")
{if(target_shape==null){ target_shape= new NDShape();}
...
/// <param name="use_linear">Whether to use L1-SVM objective. L2-SVM objective is used by default.</param>
 /// <returns>returns new symbol</returns>
public static Symbol SVMOutput(Symbol data, Symbol label, float margin=1f, float regularization_coefficient=1f, bool use_linear=false, string symbol_name="")
{
...
///<summary>
///<para>Fill one element of each line(row for python, column for R/Julia) in lhs according to index indicated by rhs and values indicated by mhs. This function assume rhs uses 0-based index.</para>
///</summary>
/// <param name="lhs">Left operand to the function.</param>
...
/// <param name="size">length of str_img</param>
 /// <returns>returns new symbol</returns>
public static Symbol Imdecode(Symbol mean, int index, int x0, int y0, int x1, int y1, int c, int size, string symbol_name="")
{
