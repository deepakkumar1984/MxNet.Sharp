...
{
    public class Conv3DTranspose : BaseLayer, ILayer
    {
        ...
        public Conv3DTranspose(uint filters, Tuple<uint, uint, uint> kernalSize, Tuple<uint, uint, uint> strides = null, uint? padding = null,
                                DeconvolutionLayout dataFormat = DeconvolutionLayout.None, Tuple<uint, uint, uint> dialationRate = null, 
