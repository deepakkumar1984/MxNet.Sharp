...
{
    public class AvgPooling2D : BaseLayer, ILayer
    {
        ...
        public Symbol Build(Symbol x)
        {
            ...
            return ops.NN.Pooling(x, new Shape(PoolSize.Item1, PoolSize.Item2), PoolingPoolType.Avg, false, Global.UseCudnn, 
                                    PoolingPoolingConvention.Valid, new Shape(Strides.Item1, Strides.Item2), pad, 0, true, ConvolutionLayout.None, ID);
        }
    }
}
