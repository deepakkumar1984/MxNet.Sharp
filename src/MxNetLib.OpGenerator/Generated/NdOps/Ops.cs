...
/// <param name="layout">Set layout for input, output and weight. Empty for    default layout: NCW for 1d, NCHW for 2d and NCDHW for 3d.NHWC and NDHWC are only supported on GPU.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Convolution(NDArray data, NDArray weight, NDArray bias, NDShape kernel, uint num_filter, NDShape stride=null, NDShape dilate=null, NDShape pad=null, uint num_group=1, ulong workspace=1024, bool no_bias=false, ConvolutionCudnnTune? cudnn_tune=null, bool cudnn_off=false, ConvolutionLayout? layout=null)
...
/// <param name="layout">Set layout for input, output and weight. Empty for default layout, NCW for 1d, NCHW for 2d and NCDHW for 3d.NHWC and NDHWC are only supported on GPU.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Deconvolution(NDArray data, NDArray weight, NDArray bias, NDShape kernel, uint num_filter, NDShape stride=null, NDShape dilate=null, NDShape pad=null, NDShape adj=null, NDShape target_shape=null, uint num_group=1, ulong workspace=512, bool no_bias=true, DeconvolutionCudnnTune? cudnn_tune=null, bool cudnn_off=false, DeconvolutionLayout? layout=null)
{if(stride==null){ stride= new NDShape();}
if(dilate==null){ dilate= new NDShape();}
if(pad==null){ pad= new NDShape();}
...
/// <param name="cudnn_off">Whether to turn off cudnn in dropout operator. This option is ignored if axes is specified.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Dropout(NDArray data, float p=0.5f, DropoutMode mode=DropoutMode.Training, NDShape axes=null, bool? cudnn_off=false)
...
/// <param name="layout">Set layout for input and output. Empty for    default layout: NCW for 1d, NCHW for 2d and NCDHW for 3d.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Pooling(NDArray data, NDShape kernel=null, PoolingPoolType pool_type=PoolingPoolType.Max, bool global_pool=false, bool cudnn_off=false, PoolingPoolingConvention pooling_convention=PoolingPoolingConvention.Valid, NDShape stride=null, NDShape pad=null, int? p_value=null, bool? count_include_pad=null, PoolingLayout? layout=null)
...
/// <param name="constant_value">The value used for padding when `mode` is "constant".</param>
 /// <returns>returns new symbol</returns>
public static NDArray Pad(NDArray data, PadMode mode, NDShape pad_width, double constant_value=0)
{
...
/// <param name="high">Upper bounds of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleUniform(NDArray low, NDArray high, NDShape shape=null, DType dtype=null)
{
...
/// <param name="sigma">Standard deviations of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleNormal(NDArray mu, NDArray sigma, NDShape shape=null, DType dtype=null)
{
...
/// <param name="beta">Beta (scale) parameters of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleGamma(NDArray alpha, NDArray beta, NDShape shape=null, DType dtype=null)
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleExponential(NDArray lam, NDShape shape=null, DType dtype=null)
{
...
/// <param name="dtype">DType of the output in case this can't be inferred. Defaults to float32 if not defined (dtype=None).</param>
 /// <returns>returns new symbol</returns>
public static NDArray SamplePoisson(NDArray lam, NDShape shape=null, DType dtype=null)
{
...
/// <param name="p">Failure probabilities in each experiment.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleNegativeBinomial(NDArray k, NDArray p, NDShape shape=null, DType dtype=null)
{
...
/// <param name="alpha">Alpha (dispersion) parameters of the distributions.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleGeneralizedNegativeBinomial(NDArray mu, NDArray alpha, NDShape shape=null, DType dtype=null)
{
...
/// <param name="dtype">DType of the output in case this can't be inferred.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleMultinomial(NDArray data, NDShape shape=null, bool get_prob=false, DType dtype=null)
...
/// <param name="shape">2-D shape of the output, where shape[0] is the batch size, and shape[1] is the number of candidates to sample for each batch.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SampleUniqueZipfian(int range_max, NDShape shape=null)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Sum(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Mean(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Prod(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Nansum(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Nanprod(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Max(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Min(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="size">Target sizes of the broadcasting axes.</param>
 /// <returns>returns new symbol</returns>
public static NDArray BroadcastAxis(NDArray data, NDShape axis=null, NDShape size=null)
...
/// <param name="shape">The shape of the desired array. We can set the dim to zero if it's same as the original. E.g `A = broadcast_to(B, shape=(10, 0, 0))` has the same meaning as `A = broadcast_axis(B, axis=0, size=10)`.</param>
 /// <returns>returns new symbol</returns>
public static NDArray BroadcastTo(NDArray data, NDShape shape=null)
{if(shape==null){ shape= new NDShape();}
...
/// <param name="rhs_axes">Axes to copy from the second input array</param>
 /// <returns>returns new symbol</returns>
public static NDArray BroadcastLike(NDArray lhs, NDArray rhs, NDShape lhs_axes=null, NDShape rhs_axes=null)
{
...
/// <param name="keepdims">If this is set to `True`, the reduced axis is left in the result as dimension with size one.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Norm(NDArray data, int ord=2, NDShape axis=null, NormOutDtype? out_dtype=null, bool keepdims=false)
{
...
/// <param name="shape">Shape of output.</param>
 /// <returns>returns new symbol</returns>
public static NDArray ScatterNd(NDArray data, NDArray indices, NDShape shape)
{
...
/// <param name="shape">Shape of output.</param>
 /// <returns>returns new symbol</returns>
public static NDArray ScatterSetNd(NDArray lhs, NDArray rhs, NDArray indices, NDShape shape)
{
...
/// <param name="reverse">If true then the special values are inferred from right to left</param>
 /// <returns>returns new symbol</returns>
public static NDArray Reshape(NDArray data, NDShape shape=null, bool reverse=false)
{if(shape==null){ shape= new NDShape();}
...
/// <param name="axes">Target axis order. By default the axes will be inverted.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Transpose(NDArray data, NDShape axes=null)
{if(axes==null){ axes= new NDShape();}
...
/// <param name="step">step for the slice operation, supports negative values.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Slice(NDArray data, NDShape begin, NDShape end, NDShape step=null)
...
/// <param name="step">step for the slice operation, supports negative values.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SliceAssign(NDArray lhs, NDArray rhs, NDShape begin, NDShape end, NDShape step=null)
{if(step==null){ step= new NDShape();}
...
/// <param name="step">step for the slice operation, supports negative values.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SliceAssignScalar(NDArray data, NDShape begin, NDShape end, double scalar=0, NDShape step=null)
{if(step==null){ step= new NDShape();}
...
/// <param name="axes">List of axes on which input data will be sliced according to the corresponding size of the second input. By default will slice on all axes. Negative axes are supported.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SliceLike(NDArray data, NDArray shape_like, NDShape axes=null)
{if(axes==null){ axes= new NDShape();}
...
/// <param name="reps">The number of times for repeating the tensor a. Each dim size of reps must be a positive integer. If reps has length d, the result will have dimension of max(d, a.ndim); If a.ndim < d, a is promoted to be d-dimensional by prepending new axes. If a.ndim > d, reps is promoted to a.ndim by pre-pending 1's to it.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Tile(NDArray data, NDShape reps)
{
...
/// <param name="axis">The axis which to reverse elements.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Reverse(NDArray data, NDShape axis)
{
...
/// <param name="axis">Selects a subset of the single-dimensional entries in the shape. If an axis is selected with shape entry greater than one, an error is raised.</param>
 /// <returns>returns new symbol</returns>
public static NDArray Squeeze(NDArray[] data, NDShape axis=null)
{
...
/// <param name="sections">Number of sections if equally splitted. Default to 0 which means split by indices.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SplitV2(NDArray data, NDShape indices, int axis=1, bool squeeze_axis=false, int sections=0)
{
...
/// <param name="shape">Shape of the array into which the multi-indices apply.</param>
 /// <returns>returns new symbol</returns>
public static NDArray RavelMultiIndex(NDArray data, NDShape shape=null)
{
...
/// <param name="shape">Shape of the array into which the multi-indices apply.</param>
 /// <returns>returns new symbol</returns>
public static NDArray UnravelIndex(NDArray data, NDShape shape=null)
{
...
/// <param name="exclude">Whether to perform reduction on axis that are NOT in axis instead.</param>
 /// <returns>returns new symbol</returns>
public static NDArray SquareSum(NDArray data, NDShape axis=null, bool keepdims=false, bool exclude=false)
{
...
/// <param name="layout">Set layout for input, output and weight. Empty for    default layout: NCHW for 2d and NCDHW for 3d.</param>
 /// <returns>returns new symbol</returns>
public static NDArray ConvolutionV1(NDArray data, NDArray weight, NDArray bias, NDShape kernel, uint num_filter, NDShape stride=null, NDShape dilate=null, NDShape pad=null, uint num_group=1, ulong workspace=1024, bool no_bias=false, ConvolutionV1CudnnTune? cudnn_tune=null, bool cudnn_off=false, ConvolutionV1Layout? layout=null)
{if(stride==null){ stride= new NDShape();}
if(dilate==null){ dilate= new NDShape();}
if(pad==null){ pad= new NDShape();}
...
/// <param name="center_crop">If set to true, then it will use be the center_crop,or it will crop using the shape of crop_like</param>
 /// <returns>returns new symbol</returns>
public static NDArray Crop(List<Symbol> data, int num_args, NDShape offset=null, NDShape h_w=null, bool center_crop=false)
...
/// <param name="target_shape">Specifies the output shape (H, W). This is required if transformation type is `affine`. If transformation type is `warp`, this parameter is ignored.</param>
 /// <returns>returns new symbol</returns>
public static NDArray GridGenerator(NDArray data, GridgeneratorTransformType transform_type, NDShape target_shape=null)
{if(target_shape==null){ target_shape= new NDShape();}
...
/// <param name="pad">pad for pooling: (y, x) or (d, y, x)</param>
 /// <returns>returns new symbol</returns>
public static NDArray PoolingV1(NDArray data, NDShape kernel=null, PoolingV1PoolType pool_type=PoolingV1PoolType.Max, bool global_pool=false, PoolingV1PoolingConvention pooling_convention=PoolingV1PoolingConvention.Valid, NDShape stride=null, NDShape pad=null)
{if(kernel==null){ kernel= new NDShape();}
if(stride==null){ stride= new NDShape();}
if(pad==null){ pad= new NDShape();}
...
/// <param name="spatial_scale">Ratio of input feature map height (or w) to raw image height (or w). Equals the reciprocal of total stride in convolutional layers</param>
 /// <returns>returns new symbol</returns>
public static NDArray ROIPooling(NDArray data, NDArray rois, NDShape pooled_size, float spatial_scale)
{
...
/// <param name="cudnn_off">whether to turn cudnn off</param>
 /// <returns>returns new symbol</returns>
public static NDArray SpatialTransformer(NDArray data, NDArray loc, SpatialtransformerTransformType transform_type, SpatialtransformerSamplerType sampler_type, NDShape target_shape=null, bool? cudnn_off=null)
{if(target_shape==null){ target_shape= new NDShape();}
